...
- 🔄 **v1.3 Onboarding Steps** — Phase 7 (active)
...
### v1.3 Onboarding Steps

- [x] **Phase 7: Onboarding Steps** — Cards sequenciais estáticos ensinando o fluxo de uso da ferramenta (completed 2026-03-24)

## Phase Details

### Phase 7: Onboarding Steps
**Goal**: Usuários entendem o fluxo da ferramenta ao ver cards numerados abaixo da lista de imagens
**Depends on**: Phase 6 (app complete with current feature set)
...
Plans:
- [x] 07-01-PLAN.md — Add OnboardingSteps component with 4 numbered cards and i18n
